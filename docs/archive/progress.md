> **ARCHIVED 2026-09-14 — historical record, not current.**
>
> This is the *Orchestration Progress Log*: the wave-by-wave build journal for
> milestones **M0–M7**. It was last updated **2026-06-25** and is preserved here
> verbatim. It predates the entire web-parity effort — every `G`-item, the Document
> Sync Agent, the on-disk SWR cache, and the M7 release work all landed afterwards.
>
> For what ships today see [`work-consolidation.md`](../../work-consolidation.md);
> for per-endpoint status see [`docs/api-coverage.md`](../api-coverage.md).
> **Do not cite this file as evidence of current app behavior.**
>
> *Link note:* relative links inside this file were re-based when it moved into `docs/archive/`.
> Several still point at documents that were **deleted** during the 2026-08 consolidation —
> `PLAN.md`, `ORCHESTRATION.md`, `API-backend-prompts-to-build.md`, `NEXT-WORK.md` (all removed in
> `f040954`, content folded into `work-consolidation.md`). Those links are left as written rather
> than rewritten: this is a frozen record, and the references are part of what it records.
